...
--A special exception breakpoint is raised when the unit is maximum life reaches exactly 1000
clicli.develop.helper.createAttrWatcher(unit, 'Maximum life', 1000)

--Raises a special exception breakpoint when a unit is health drops below half of its maximum life
clicli.develop.helper.createAttrWatcher(unit, 'HP', '<= `Maximum life` / 2')
