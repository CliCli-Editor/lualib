...
function M:in_state(state)
    ---@private
    self._in_state = (self._in_state or 0) | (clicli.const.UnitEnumState[state] or state)
    return self
end
...
function M:not_in_state(state)
    ---@private
    self._not_in_state = (self._not_in_state or 0) | (clicli.const.UnitEnumState[state] or state)
    return self
end
